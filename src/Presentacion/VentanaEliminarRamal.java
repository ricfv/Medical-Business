...
public class VentanaEliminarRamal extends JFrame {
	 ...
	 */
	public VentanaEliminarRamal(ControlRegistroRamales control) {
		super();
		initialize();
	...
	private JPanel getJContentPane() {
		if (jContentPane == null) {
			...
			jLabel1.setText("Eliminar ramal");
